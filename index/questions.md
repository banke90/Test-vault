...
- **Do arms have anything recoverable as their own experience**, or is the integration tight enough that there is phenomenologically only one octopus? → [[octopus-arms-do-their-own-motor-planning]] / [[the-octopus-is-an-independent-second-evolution-of-mind]]
- **Does skin photoreception contribute to what the octopus "sees"** in a behaviourally meaningful sense? → [[octopus-skin-is-photosensitive]]
...
- **Is there an analogue of grammar for a transformer?** Can circuits be composed in predictable ways, or are they always ad hoc? → [[induction-heads-are-the-archetypal-circuit]]
...
- **Are features shared across models?** Early crosscoder work suggests partial universality. Is there a natural vocabulary that large models converge on? → [[sparse-autoencoders-extract-monosemantic-features]]
- **Can MI catch deliberate sandbagging** — a model that internally represents "I could answer this better but won't"? The alignment question MI most needs to answer and hasn't yet. → [[mechanistic-interpretability]] / [[attribution-graphs-explain-specific-prompts-not-models]]
- **Can MI tools measure the *fraction* of a model's computation they've explained?** Without a fraction metric, coverage claims are vague. → [[attribution-graphs-explain-specific-prompts-not-models]]
...
- **Does the octopus have experience, and if so, what kind?** Single most informative possible result for the substrate-independence question. → [[hard-problem-consciousness]] / [[the-octopus-is-an-independent-second-evolution-of-mind]]
