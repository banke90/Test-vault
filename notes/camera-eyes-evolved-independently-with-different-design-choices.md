...
Eyes have evolved 50–100 times, but only a handful of lineages evolved the **camera-type** design (focusing lens, image-forming retina): vertebrates, cephalopods, box jellyfish, alciopid annelids, a few gastropods. The optics converge but the wiring differs sharply: the vertebrate retina is **inverted** (photoreceptors point away from the light, axons cross in front, producing a blind spot at the optic disc), the cephalopod retina is **everted** (photoreceptors face the light, axons exit the back, no blind spot) — both frozen accidents of how the eye develops, vertebrate from an evaginated brain pouch, cephalopod from a different route. The deep-homology surprise is that a single transcription factor, **PAX6**, regulates eye development in all of them, including insects — a shared regulatory ancestry beneath morphology that evolved independently.
